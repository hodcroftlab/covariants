    ...
    <InfoTable>
      <tbody>
        <tr>
          ...
          <td>
            <NextstrainCladeInfo nextstrainClade={cluster.nextstrainClade} />
          </td>
        </tr>
        <tr>
...
function NextstrainCladeInfo({ nextstrainClade }: { nextstrainClade: string }) {
  if (!nextstrainClade) {
    return <span>None</span>
  }

  if (nextstrainClade === 'recombinant') {
    return <span>Recombinant</span>
  }
