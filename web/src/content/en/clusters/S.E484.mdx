...
import { Var } from 'web/src/components/Common/Badges/VariantBadge'
...
Unlike the two variants above, it does *not* carry <AaMut mut={'S:N501Y'}/> in Spike. It does have mutations in Nucleocapsid: <AaMut mut={'N:A119S'}/> and <AaMut mut={'N:M234I'}/> and in <code>ORF1a</code>: <AaMut mut={'ORF1a:L3458V'}/> and <AaMut mut={'ORF1a:L3930F'}/>.
