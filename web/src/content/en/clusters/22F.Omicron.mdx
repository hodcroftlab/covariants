...
Some sublineages within <VarOrLin name="22F (Omicron)" prefix=""/>, particularly <Lin name="XBB.1" />, have acquired the additional amino acid mutations <AaMut mut={"S:G252V"}/> (<NucMut mut="G22317T"/>) and <AaMut mut={"ORF8:G8*"}/> (<NucMut mut="G27915T"/>).
...
- The same study also found that <VarOrLin name="22F (Omicron)" prefix=""/> can escape the monoclonal antibodies (mAbs) Evusheld and Bebtelovimab, making clinically available mAbs as of October 2022 likely ineffective against the variant. Additionally, <VarOrLin name="22F (Omicron)" prefix=""/> sublinages <Lin name="XBB.1" /> escaped all NTD-targeting neutralizing antibodies tested ([Cao et al. bioRxiv](https://www.biorxiv.org/content/10.1101/2022.09.15.507787v4))
