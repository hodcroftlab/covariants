...
<AaMut mut="S:Y453F"/> 之前在荷兰的水貂中也曾出现过 (<LinkExternal href="https://nextstrain.org/groups/neherlab/ncov/netherlands?c=gt-S_453&f_country=Netherlands&f_host=Mink">Nextstrain构建例子</LinkExternal>).
