export const CLADE_COLORS: Record<string, { bg: string; fg: string }> = {
  ...
  '20I': { bg: '#492AB5', fg: '#FFFFFF' },
  '20J': { bg: '#4042C7', fg: '#FFFFFF' },
  '21A': { bg: '#3E5DD0', fg: '#FFFFFF' },
  '21I': { bg: '#4377CD', fg: '#000000' },
  '21J': { bg: '#4A8CC2', fg: '#000000' },
  '21B': { bg: '#549DB2', fg: '#000000' },
  '21C': { bg: '#60AA9E', fg: '#000000' },
  '21D': { bg: '#6EB389', fg: '#000000' },
  '21E': { bg: '#80B974', fg: '#000000' },
  '21F': { bg: '#92BC63', fg: '#000000' },
  '21G': { bg: '#A6BE55', fg: '#000000' },
  '21H': { bg: '#B9BC4A', fg: '#000000' },
  '21K': { bg: '#CBB742', fg: '#000000' },
  '21L': { bg: '#D9AD3D', fg: '#000000' },
  '22A': { bg: '#E29D39', fg: '#000000' },
  '22B': { bg: '#E68634', fg: '#000000' },
  '22C': { bg: '#E56A2F', fg: '#000000' },
  '22D': { bg: '#E04929', fg: '#000000' },
  '22E': { bg: '#DB2823', fg: '#000000' },
}
