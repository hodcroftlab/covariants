export const CLADE_COLORS: Record<string, { bg: string; fg: string }> = {
  ...
  '20H': { bg: '#5056E1', fg: '#FFFFFF' },
  '20I': { bg: '#5C85E7', fg: '#FFFFFF' },
  '20J': { bg: '#6EABD3', fg: '#FFFFFF' },
  '21A': { bg: '#82C2AD', fg: '#000000' },
  '21B': { bg: '#9BD088', fg: '#000000' },
  '21C': { bg: '#B8D56B', fg: '#000000' },
  '21D': { bg: '#D5D35A', fg: '#000000' },
  '21E': { bg: '#EEC54F', fg: '#000000' },
  '21F': { bg: '#F2A446', fg: '#000000' },
  '21G': { bg: '#EF703A', fg: '#000000' },
  '21H': { bg: '#E6392F', fg: '#000000' },
}
