export const CLADE_COLORS: Record<string, { bg: string; fg: string }> = {
  ...
  '20H': { bg: '#4B26B1', fg: '#FFFFFF' },
  '20I': { bg: '#3F4ACA', fg: '#FFFFFF' },
  '20J': { bg: '#4272CE', fg: '#FFFFFF' },
  '21A': { bg: '#4D92BF', fg: '#000000' },
  '21B': { bg: '#5DA8A3', fg: '#000000' },
  '21C': { bg: '#74B583', fg: '#000000' },
  '21D': { bg: '#8EBC66', fg: '#000000' },
  '21I': { bg: '#ACBD51', fg: '#000000' },
  '21J': { bg: '#C8B944', fg: '#000000' },
  '21E': { bg: '#DDA93C', fg: '#000000' },
  '21F': { bg: '#E68B35', fg: '#000000' },
  '21G': { bg: '#E3602D', fg: '#000000' },
