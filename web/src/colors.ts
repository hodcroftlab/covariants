export const CLADE_COLORS: Record<string, { bg: string; fg: string }> = {
  ...
  '20E': { bg: '#930876', fg: '#000000' },
  '20F': { bg: '#9609A7', fg: '#000000' },
  '20G': { bg: '#9B0AE6', fg: '#000000' },
  '20H': { bg: '#546DE9', fg: '#FFFFFF' },
  '20I': { bg: '#6196CD', fg: '#FFFFFF' },
  '20J': { bg: '#7FC0B3', fg: '#000000' },
  '21A': { bg: '#9CD085', fg: '#000000' },
  '21B': { bg: '#BFD566', fg: '#000000' },
  '21C': { bg: '#E1CE54', fg: '#000000' },
  '21D': { bg: '#F4B24A', fg: '#000000' },
  '21E': { bg: '#EF7B3D', fg: '#000000' },
  '21F': { bg: '#E6392F', fg: '#000000' },
}
