...
This variant is one of 4 "Variants of Concern" (as designated by the WHO):
- <Var name="20I (Alpha, V1)" prefix=""/> or `B.1.1.7`
- <Var name="20H (Beta, V2)" prefix=""/> or `B.1.351`
- <Var name="20J (Gamma, V3)" prefix=""/> or `P.1`
- <Var name="21A (Delta)" prefix=""/> or `B.1.617.2`
