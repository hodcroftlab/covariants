...
(See the <Link href="/shared-mutations">Shared Mutations Table</Link> for a full list of shared mutations.) In addition, it has a spike mutations at position <AaMut mut={"S:T732A"}/>.
