...
This variant carries two mutations that are also seen in the variants of concern/interest: <AaMut mut={"S:T478K"}/> (also seen in <Var name="21A (Delta)" prefix=""/>) and <AaMut mut={"S:P681H"}/> (see <Mut name="S:P681"/>). (See the [Shared Mutations Table](/shared-mutations) for a full list of shared mutations.) In addition, it has a spike mutations at position <AaMut mut={"S:T732A"}/>.
