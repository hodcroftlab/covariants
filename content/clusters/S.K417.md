<AaMut mut={"S:K417N"}/> is present in <Var name="20H (Beta, V2)"/>, <Var name="21K (Omicron)"/> and <Var name="21L (Omicron)"/>. <AaMut mut={"S:K417T"}/> is present in <Var name="20J (Gamma, V3)"/>.
